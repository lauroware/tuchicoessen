...
const RecetasScreen = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      receta:
        "Mezclamos 100  gr de avena instantanea, 5 sobresitos de stevia, agregamos 2 cucharadas generosas de cacao en polvo amargo, incluimo un huevo y esencia de vainilla, mezclamos bien hasta que quede una masa menajable, vamos a hacer bolitas con la masa, le damos forma de pepa directamente en la sartén (yo usé la flip), y le incluimos el relleno en el medio, cocinamos por 20 minutos. Salen 5 o 6 dependiendo el tamaño.",
      instagramLink:
    ...
    },
    {
      ...
      receta:
        "Empezamos separando las yemas y claras, a las yemas le agregamos ricota, esencia de vainilla, miel, rayadura y jugo de un limón y 3 cucharadas de avena. Procesamos la mezcla. Montamos las claras a nieve, y mezclamos con la primer mezcla. Llevamos al savarin y desmoldamos! A disfrutar chiquis!",
      instagramLink:
    ...
    },
    {
      ...
      receta:
        "3Ponemos todos los ingredientes en la licuadora! Una lata de lentejas, 3 huevos, 6 cucharadas de aceite de oliva, sal y pimienta a gusto. Una cucharada generosa de polvo para hornear. Licuamos bien hasta que quede bien liso, metemos toda la preparación en la flip. Con 40 minutos a fuego corona cocinamos desmoldamos y dejamos enfriar bien el pan antes de cortarlo, hace un tremendo sanguche con lo que más te guste!",
      instagramLink:
